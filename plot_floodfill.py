...
cameraman1 = cv2.imread('unnamed.jpg')
cameraman = cv2.cvtColor(cameraman1, cv2.COLOR_BGR2GRAY)
...
for i in range(8):
    tol = 5 + 20 * i
    output.append(flood_fill(cameraman, (155, 150), 255, tolerance=tol))
